...
public class DateConvertUtils {
  ...
  public static final String DATE_FORMAT_NOT = "MMddHHmmss";
  public static final String DATE_FORMAT_NOTS = "yyyyMMddHHmm";
  public static final String DATE_TIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
  public static final String DATE_TIME_FORMAT_CON = "yyyyMMddHHmmss";
  public static final String DATE_TIME_FORMAT_MIL = "yyyyMMddHHmmssSSS";
  ...
  public static final String DATE_TIME_SSSS_ = "yyyy-MM-dd HH:mm:ss.SSS";
   ...
   * 转换UTC时间
   */
  public static Date local2UtcDate(Date localDate) {
   ...
   * 转化UTC时间字符串
   */
  public static String local2UtcStr(Date localDate) {
    Date utcDate = local2UtcDate(localDate);
    return format(utcDate, DateConvertUtils.DATE_TIME_SSSS_FORMAT);
  }

  public static Date convertCoreToLocalDate(String dateStr) {
    Date coreDate = string2Date(dateStr, DATE_TIME_SSSS_FORMAT);
    Date localDate = addHour(coreDate, timeZone());
    return localDate;
  }

  public static String convertLocalToCoreDate(String date) {
    Date d = parse(date, DATE_TIME_FORMAT);
    d = addHour(d, 0 - timeZone());
    return format(d, DATE_TIME_SSSS_FORMAT);
  }
  ...
  public static Date addHour(Date date, int hours) {
    Calendar ins = Calendar.getInstance();
    ins.setTime(date);
    ins.add(Calendar.HOUR_OF_DAY, hours);
    return ins.getTime();
  }
  ...
  public static int timeZone() {
    ...
    hour = (new Date().getTime() - timeStampUTC) / (1000 * 3600);
    return (int) hour;
  }
  ...
  public static Date addSeconds(Date date, int second) {
    Calendar ins = Calendar.getInstance();
    ins.setTime(date);
    ins.add(Calendar.SECOND, second);
    return ins.getTime();
  }
}
